    ...
    return (  
        ...
        <div className="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center">
          <div className="col-lg-7 p-3 p-lg-5 pt-lg-3">
            ...
            <p className="lead">In a world filled with music, podcasts, and entertainment on the go, having the right headphones can make all the difference. Whether you're a music enthusiast, a gamer seeking immersive experiences, or someone who values clear communication during calls, our premium headphones are designed to cater to your audio needs.</p>
